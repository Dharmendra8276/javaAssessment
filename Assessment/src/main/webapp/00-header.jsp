...
<link rel="shortcut icon" href="${ctxPath}/images/favicon.ico" type="image/x-icon" />
<link rel="stylesheet" type="text/css" href="${ctxPath}/css/style.css">
<link rel="stylesheet" type="text/css" href="${ctxPath}/css/jquery-ui.min.css">
<link rel="stylesheet" type="text/css" href="${ctxPath}/css/jquery-ui-timepicker-addon.min.css">
<script type="text/javascript" src="${ctxPath}/js/jquery-2.0.3.min.js"></script>
<script type="text/javascript" src="${ctxPath}/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="${ctxPath}/js/jquery-ui-timepicker-addon.min.js"></script>
<script type="text/javascript" src="${ctxPath}/js/script.js"></script>
<script type="text/javascript" src="${ctxPath}/js/stupidtable.min.js"></script>
...
<body>
	<div class="main">
		<div class="top-banner">
			<div class="container">
				<a href="${ctxPath}/manager/home"><img
					src="${ctxPath}/images/logo2.png" height="80"></a>
			</div>
		</div>
		<div class="top-menu">
			<div class="container">
				<ul class="navigation">
					...
					<li><a>DATA MANAGEMENT &raquo;</a>
						<ul>
							<li><a href="${ctxPath}/manager/chargepoints">CHARGE
									POINTS</a></li>
							<li><a href="${ctxPath}/manager/ocppTags">OCPP TAGS</a></li>
							<li><a href="${ctxPath}/manager/users">USERS</a></li>
							<li><a href="${ctxPath}/manager/chargingProfiles">CHARGING
									PROFILES</a></li>
					...
					<li><a>OPERATIONS &raquo;</a>
						<ul>
							<li><a href="${ctxPath}/manager/operations/v1.2">OCPP
									v1.2</a></li>
							<li><a href="${ctxPath}/manager/operations/v1.5">OCPP
									v1.5</a></li>
							<li><a href="${ctxPath}/manager/operations/v1.6">OCPP
									v1.6</a></li>
